/**
 * Example: WalletConnect Integration with Talent Ledger
 * 
 * This example demonstrates how to integrate WalletConnect with your Stacks dApp
 * to enable wallet connections and interact with the talent-ledger contract.
 */
...
/**
 * Example 3: Interact with Talent Ledger Contract via WalletConnect
 * 
...
export async function exampleContractInteraction() {
  ...
  const exampleRequest = {
    ...
    params: {
      contract: 'SPHB047A30W99178TR7KE0784C2GV22070JTKX8.talent-ledger',
...
export async function completeExample() {
  ...
  console.log('WalletConnect + Talent Ledger - Complete Example');
  console.log('='.repeat(60));
